...
<div class="pageContent">
	<form method="post" action="${ctx}/work/parkinglockoperationevent/${action}" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
		<input type="hidden" name="id" value="${id}">
		<vsc:token tokenName="work.parkinglockoperationevent.create"></vsc:token>
		...
		<div class="pageFormContent" layoutH="56">
			<table class="formTable">
					...
					<tr>
					<td class="fieldName">RESULT_TYPE:</td>
						<td class="fieldInput"><label><input type="text" id="resultType" name="resultType" value="${vm.resultType}" validate="{required:true}"/></label><span for="resultType" generated="true" style="display: none" class="error"></span>
						</td>
					</tr>
					<tr>

...
(function($){
	...
	$.extend({
		bringBackSuggest: function(args){
			...
			var _stnid="#"+_lookup.currentGroup + "_" + 'selectedTotalNum';
			var $selectedTotalNum=$box.find(_stnid);
			$box.find(":input").each(function(){
				...
				for (var key in args) {
					...
					if (name == inputName) {
						...
						if($selectedTotalNum&&args[key]){
						  $selectedTotalNum.html(args[key].split(",").length);
						}
						break;
				...
				$this.click(function(event){
					...
					if (attrData){
						...
						for (var key in attrs) { 
							var _dv=attrs[key];
							if( typeof _dv == "string" && _dv.startsWith("javascript:")){

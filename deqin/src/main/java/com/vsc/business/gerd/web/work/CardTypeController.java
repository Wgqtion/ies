 ...
 */
@Controller
@RequestMapping(value = Constants.SPT + CardTypeController.PATH)
public class CardTypeController extends BaseController {
	...
	public static final String PATH = "work/cardtype";
	...
	public String list(Model model, HttpServletRequest request) {
		...
		Page<CardType> page = cardTypeService.findPage(searchParams,
				pageRequest);
	...
	public ModelAndView exportList(HttpServletRequest request) {
		Map<String, Object> searchParams = this.getSearchRequest();
		List<CardType> list = cardTypeService.findAll(searchParams,
	...
	public String createForm(Model model) {
		model.addAttribute("vm", new CardType());
		model.addAttribute("action", BaseController.CREATE);
		return PATH_EDIT;
	}

	@RequestMapping(value = BaseController.CREATE, method = RequestMethod.POST)
	public ModelAndView create(@Valid CardType cardType) {
	...
	public String updateForm(@PathVariable("id") Long id, Model model) {
		model.addAttribute("vm", cardTypeService.getObjectById(id));
	...
	public ModelAndView update(
			@Valid @ModelAttribute("preloadModel") CardType cardType) {
		cardTypeService.save(cardType);
	...
	public ModelAndView deleteBatch(@RequestParam Long[] ids) {
		cardTypeService.deleteByIds(ids);
		return this.ajaxDoneSuccess("删除成功");
	}
	...
	public ModelAndView sync(Model model, ServletRequest request) {
		...
		this.syncLogService.addSyncLog("sys", "同步进校证类型", "sys");
		return this.ajaxDoneSuccess("同步进校证类型数据成功");
	}
	...
	public String select(Model model, ServletRequest request) {
		...
		Map<String, Object> searchParams = this.getSearchRequest();
		Page<CardType> page = this.cardTypeService.findPage(searchParams,
				pageRequest);
		model.addAttribute("page", page);
		return PATH_SELECT;
	}
	...
	public CardType getModel(
			@RequestParam(value = "id", required = false) Long id) {
		if (id != null) {
			return cardTypeService.getObjectById(id);
		}
		return null;
	}

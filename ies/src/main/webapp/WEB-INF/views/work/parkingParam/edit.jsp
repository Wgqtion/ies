		...
		<div class="pageFormContent" layoutH="56">
			<table class="formTable">
				<tr>
					...
					<td style="color: red;">所有参数设置为0则不生效</td>
				</tr>
				<tr>
				...
				<tr>
					<td class="fieldName"><label><span class="required">*</span>预约限免时间:</label></td>
					<td class="fieldInput">
						<label>
						<input type="text" id="freeReserveMin" value="${vm.freeReserveMin}" name="freeReserveMin" validate="{required:true,digits:true,min:0}" />分钟
						</label>
						<span for="freeReserveMin" generated="true" style="display: none" class="error"></span>
					</td>
					<td class="fieldName"><label><span class="required">*</span>停车限免时间:</label></td>
					<td class="fieldInput">
						<label>
						<input type="text" id="freeParkingMin" value="${vm.freeParkingMin}" name="freeParkingMin" validate="{required:true,digits:true,min:0}" />分钟
						</label>
				...
				<tr>
					<td class="fieldName"><label><span class="required">*</span>预约费用总上限:</label></td>
					<td class="fieldInput">
						<label>
					...
					<td class="fieldName"><label><span class="required">*</span>停车费用总上限:</label></td>
					<td class="fieldInput">
						<label>

...
<script>
	...
	var searchzNodesParkingPassages =[
	...
	$(function(){
		GenerateSearcchZTree(searchzNodesParkingPassages,'ParkingPassages','${param.search_IN_parkingLotCode}');
	});

	
</script>
<div id="searchBodyParkingPassages" >
		...
		<form rel="pagerForm" onsubmit="return navTabSearch(this);" action="${ctx}/work/parkingpassages" method="post">
			<div class="searchBar">
				<ul class="searchContent">
					<li>
						<label>场区:</label>
						<input type="hidden" id="searchCodeParkingPassages" name="search_IN_parkingLotCode" value="${param.search_IN_parkingLotCode}"/>
						<input  id="searchNameParkingPassages" name="searchNameParkingPassages" value="${param.searchNameParkingPassages}" readonly="readonly" onclick="showSearchZTree(this,'ParkingPassages');"/>
					</li>
	...
	<div id="searchContentParkingPassages" class="menuContent" style="display: none;position: absolute;">
	   <ul id="searchTreeParkingPassages" class="ztree editZtree" style="margin-top:0; width:200px;"></ul>
	</div>
</div>

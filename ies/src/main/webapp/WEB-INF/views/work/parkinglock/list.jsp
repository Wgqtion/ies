...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" title="添加地锁" href="${ctx}/work/parkinglock/new?navTabId=work_parkinglock" target="dialog" rel="parkinglock_new"><span>添加</span></a></li>
			<li><a class="edit" title="编辑地锁" href="${ctx}/work/parkinglock/update/{sid}?navTabId=work_parkinglock" target="dialog" rel="parkinglock_update" warn="请选择一个记录"><span>编辑</span></a></li>
